...
@login_required
@permission_required('continuing_education.view_training', raise_exception=True)
...
@login_required
@permission_required('continuing_education.change_training', raise_exception=True)
