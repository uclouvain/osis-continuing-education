...
from continuing_education.views.common import save_and_create_revision, get_revision_messages, UCL_REGISTRATION_SENDED, \
    UCL_REGISTRATION_REGISTERED, UCL_REGISTRATION_REJECTED
...
def save_role_registered_in_admission(data):
    ...
    if data['success']:
        ...
        save_and_create_revision("EPC", get_revision_messages(UCL_REGISTRATION_REGISTERED), admission)
    else:
        admission.ucl_registration_complete = ucl_registration_state_choices.REJECTED
        save_and_create_revision("EPC", get_revision_messages(UCL_REGISTRATION_REJECTED), admission)
