...
class UrlsTestCase(TestCase):
    def test_url(self):
        routes_to_test = [
            ...
            dict(
                url_path="/continuing_education/admission/new/",
                pattern_name="admission_new",
            ),
            dict(
                url_path="/continuing_education/admission/edit/1/",
                pattern_name='admission_edit',
                kwargs={'admission_id': 1}
            ),
            dict(
                url_path="/continuing_education/admission/1/",
                pattern_name='admission_detail',
                kwargs={'admission_id': 1}
            ),
            dict(
                url_path="/continuing_education/registration/",
            ...
            dict(
                url_path="/continuing_education/files/",
                pattern_name='file_api',
            ),
        ]
